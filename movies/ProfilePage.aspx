...
<div class="card">
    <asp:Label ID="Label3" runat="server" Text="Add profile picture:"></asp:Label>
    <asp:Image ID="Image1" Width="70%" runat="server" />
     <asp:FileUpload ID="FileUpload1" runat="server" onchange="imagepreview(this);" Width="20%" style="margin-top:10px; color:white; resize:none;" Height="24px" />  
   <br />
    <img id="imgprw" style="color: white; width: 100%;" alt="Lütfen resim yükleyiniz." />

    <br />

    <asp:Label ID="Label1" runat="server" Text="Update Username:"></asp:Label>
    <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
    <br />
    <asp:Label ID="Label2" runat="server" Text="Update Password:"></asp:Label>
